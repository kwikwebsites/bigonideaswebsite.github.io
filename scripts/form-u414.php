...
$form = array(
	...
	'email' => array(
		'from' => 'bigonideas@yahoo.com',
		'to' => 'bigonideas@yahoo.com'
	),
	'fields' => array(
		'custom_U415' => array(
			'order' => 1,
		...
		'custom_U467' => array(
			'order' => 3,
			'type' => 'checkboxgroup',
			'label' => 'Services you are interseted in',
			'required' => true,
			'optionItems' => array(
				'Brand Identity',
				'Marketing Design',
			...
			'errors' => array(
				'required' => 'Field \'Services you are interseted in\' is required.',
				'format' => 'Field \'Services you are interseted in\' has an invalid value.'
			)
		)
	)
);
